...
\begin{minipage}{\linewidth}
	...
	\fontsize{4}{4}\selectfont{$\text{layer: }[-35,-45-30-45]$}
	\end{minipage}\hfill
	\begin{minipage}{0.2\textwidth}
		\centering
		\scalebox{.5}{
...
\begin{minipage}{\linewidth}
	...
	\begin{minipage}{0.1\textwidth}
	\centering
		\tiny{Axial + transversal $(\lambda F_{\perp}$) load with $\lambda \in\{1 ; 2 ; 5 ; 10 ; 20 ; 30\}$}
\end{minipage}\hfill
