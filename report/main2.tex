...
\begin{figure*}[bt!]
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/fabric/bothload/V_X.pdf}
		\caption{Spostamento lungo $\hat y$ del bordo con $y=0$ della piastra}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/fabric/bothload/W_Y.pdf}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/fabric/bothload/W_X.pdf}
		\caption{Effetto flessionale, spostamento lungo $z$ del bordo $y=0$ della piastra}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/fabric/transversal_load/V_X.pdf}
		\caption{Spostamento lungo $\hat y$ del bordo con $y=0$ della piastra}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/fabric/transversal_load/W_Y.pdf}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/fabric/transversal_load/W_X.pdf}
		\caption{Effetto flessionale, spostamento lungo $z$ del bordo $y=0$ della piastra}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/fabric/axial_load/V_X.pdf}
		\caption{Spostamento lungo $\hat y$ del bordo con $y=0$ della piastra}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/fabric/axial_load/W_Y.pdf}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/fabric/axial_load/W_X.pdf}
		\caption{Effetto flessionale, spostamento lungo $z$ del bordo $y=0$ della piastra}
...
\begin{figure*}[bt!]
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/caso_B_e_D/bothload/V_X.pdf}
		\caption{Spostamento lungo $\hat y$ del bordo con $y=0$ della piastra}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/caso_B_e_D/bothload/W_Y.pdf}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/caso_B_e_D/bothload/W_X.pdf}
		\caption{Effetto flessionale, spostamento lungo $z$ del bordo $y=0$ della piastra}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/caso_B_e_D/transversal_load/V_X.pdf}
		\caption{Spostamento lungo $\hat y$ del bordo con $y=0$ della piastra}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/caso_B_e_D/transversal_load/W_Y.pdf}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/caso_B_e_D/transversal_load/W_X.pdf}
		\caption{Effetto flessionale, spostamento lungo $z$ del bordo $y=0$ della piastra}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/caso_B_e_D/axial_load/V_X.pdf}
		\caption{Spostamento lungo $\hat y$ del bordo con $y=0$ della piastra}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/caso_B_e_D/axial_load/W_Y.pdf}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[width=\textwidth]{/more_test/caso_B_e_D/axial_load/W_X.pdf}
		\caption{Effetto flessionale, spostamento lungo $z$ del bordo $y=0$ della piastra}
