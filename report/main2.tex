...
Non sono presenti neanche effetti estensionali e lo spostamento lungo $\hat y$ del bordo della piastra è inferiore a $5 \cdot 10^{-4}. 

Andando a vedere le tensioni lungo lo spessore, ovvero al varare della coordinata $z \in \left[-{h\over 2};{h\over 2}\right]$ è possibile vedere l'andamento lineare a tratti. L'andamento lineare è dato dalle deformazioni che moltiplicano un coefficiente di rigidezza diverso layer per layer. 
...
Alcuni casi possono essere semplici da prevedere come l'allineamento di tutte le fibre lungo una stessa direzioni. Casi più complessi, come layout sbilanciati, posso portare a comportamenti strutturali non sempre facili da predire. 
...
Inoltre, permette di tenere in conto anche delle tensioni interne nei singoli layer che presentano una discontinuità all'interfaccia layer-layer successivo. 
...
Per implementare le campagne di simulazioni è stato utilizzato il software \texttt{Mathematica} \citep{mathematica} con il pacchetto aggiuntivo\texttt{ AceGEN/AceFEM} \citep{ace}. 
